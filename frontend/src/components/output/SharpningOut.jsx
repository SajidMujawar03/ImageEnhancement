...
const SharpningOut = () => {
  ...
  return (
    <div className="flex flex-col items-center pt-[100px] space-y-8 bg-gray-100 min-h-screen pb-[50px]">
      {/* Title Section */}
      <h1 className="text-3xl font-bold text-gray-800">Image Enhancement</h1> 
      <p className="text-gray-600 text-lg max-w-2xl text-center">
        Compare the original image with the enhanced version processed using our sharpening algorithm.
      </p>
